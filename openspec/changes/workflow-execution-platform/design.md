...
**What this decision does NOT yet settle** (tracked as their own tasks, not blocked on re-opening this decision): 1.9 (service-nesting mechanism cost, coupled to this choice). 1.10 (placement-resolver), 1.5 (generic IR interpreter), and 1.6 (secrets-broker product) are now all done - see `placement-resolver/FINDINGS.md`, `spikes/1.5-ir-interpreter/FINDINGS.md`, and `spikes/1.6-secrets-broker-eval/FINDINGS.md` respectively.
